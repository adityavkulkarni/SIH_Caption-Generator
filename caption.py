  ...
  with tf.Session(graph=g) as sess:
    ...
    for filename in filenames:
      ...
      for i, caption in enumerate(captions):
        ...
        cap_d[i] = (sentence,math.exp(caption.logprob))
      with open(path1+'temp.pickle', 'wb') as f:
        pickle.dump(cap_d, f)
      print('Temp Stored at'+path1)
def run(img_path=''):
  global path1
  #path1 = os.curdir+'/'
  ...
  tf.flags.DEFINE_string("checkpoint_path", path1+"im2txt/model/new/model.ckpt-2000000",
                       "Model checkpoint file or directory containing a "
                       "model checkpoint file.")
  tf.flags.DEFINE_string("vocab_file", path1+"im2txt/data/new/word_counts.txt", "Text file containing the vocabulary.")
  tf.flags.DEFINE_string("input_files", img_path,
